  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-square bg-white overflow-hidden">
        <Link href={`/productos/${producto.id}`} className="block absolute inset-0">
          {imagenPrincipal ? (
            <Image
              src={imagenPrincipal}
              alt={producto.nombre}
        ...
        {producto.destacado && (
          <span className="absolute top-3 left-3 bg-brand-900 text-white text-[10px] tracking-widest uppercase px-2 py-1 z-10">
            Destacado
          </span>
        )}
        {producto.stock === 0 && (
          <span className="absolute top-3 right-3 bg-gray-800/80 text-white text-[10px] tracking-widest uppercase px-2 py-1 z-10">
            Sin stock
          </span>
        )}
        ...
        {whatsappNumber && (
          <a
            ...
            className="absolute inset-x-0 bottom-0 bg-brand-900/90 text-white text-xs tracking-widest uppercase py-3 text-center translate-y-full group-hover:translate-y-0 transition-transform duration-300 flex items-center justify-center gap-2 z-10"
          >
